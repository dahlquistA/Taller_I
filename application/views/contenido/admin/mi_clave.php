<div style="min-height: 500px">
	...
	<div class="d-flex justify-content-center align-items-center " >
		<div class="col-md-8">
			...
			<form action="<?=base_url('actualizarClave/') . $id_persona;?>"  method="post" enctype="multipart/form-data">
				<hr />
           ...
           <button type="submit" class="btn btn-success" name="submit" >Modificar</button>
	 	   <a href="<?=site_url('misDatosAdmin')?>"><div class="btn btn-success float-right"  >Volver</div></a>
        </form>
    </div>
</div>
<hr />
